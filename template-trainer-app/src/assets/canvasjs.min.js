...
(function () {
  ...
  function Ta(k, m, u, r, w) {
    if (null === k || "undefined" === typeof k)
      return "undefined" === typeof u ? m : u;
    k =
      parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof r &&
      ((k = Math.min(r, k)), "undefined" !== typeof w && (k = Math.max(w, k)));
      ...
      : this.parent &&
        ...
        (null === w
          ...
          : 0 < this.parent.themeOptions[m].length &&
            ...
            (k = this.parent.themeOptions[m][w])));
    this.themeOptions = k;
  ...
  function ya(k, m) {
    ...
    if (r(this.options.margin) && k.options.subtitles)
      for (var u = k.options.subtitles, w = 0; w < u.length; w++)
        if (
          ((r(u[w].horizontalAlign) && "center" === this.horizontalAlign) ||
            u[w].horizontalAlign === this.horizontalAlign) &&
          ((r(u[w].verticalAlign) && "top" === this.verticalAlign) ||
  ...
  (function () {
    T.fSDec = function (k) {
      for (var m = "", u = 0; u < k.length; u++)
        m += String.fromCharCode(
          Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(u)
        );
      return m;
    };
    T.obj = {
        ...
        try {
          ...
          u =
            "cm" === T.pos[m] || "um" === T.pos[m]
              ? 0
              : k.width - w[T.fSDec(T.obj.msTxt)](T.fSDec(T.obj.trVs)).width;
          r = "um" === T.pos[m] ? 0 : k.height - 11;
          w[T.fSDec(T.obj.fTx)](T.fSDec(T.obj.trVs), u, r);
          "cs" === T.pos[m] &&
            (k[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"));
        } catch (y) {}
    };
  })();
  var hb = (function () {
    ...
    ea = function (k, m, u) {
      ...
      J &&
        ...
        (V = 0 === k ? 0 : 0 === m ? -(H + F) : String(m).length - H),
        (D /= Math.pow(10, V)));
      0 > N && (N = L);
      D = (k * D).toFixed(Q);
      m = D.split(".");
        ...
        if (((m = M.pop()), "#" === m || "0" === m))
          if ((N++, N === H)) {
            ...
            for (; 0 < W.length; )
              (u = W.pop() + u),
                J++,
                0 === J % F && L === R && 0 < W.length && (u = y + u);
          } else
            0 < D.length
              ? ((u = D.pop() + u), Q++, J++)
              : "0" === m && ((u = "0" + u), Q++, J++),
              0 === J % F && L === R && 0 < D.length && (u = y + u);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
    ...
    Pa = function (k) {
      ...
      k.offsetX || 0 === k.offsetX
        ? ((m = k.offsetX), (u = k.offsetY))
        : k.layerX || 0 == k.layerX
        ? ((m = k.layerX), (u = k.layerY))
        : ((m = k.pageX - k.target.offsetLeft),
          (u = k.pageY - k.target.offsetTop));
      return { x: m, y: u };
    },
    ab = !0,
    ...
    ca = function (k, m, u, r, w, y, D, F, N, M, T, Q, J) {
      ...
      0 < D &&
        ...
        (k.strokeStyle = F),
        k.moveTo(m, u),
        k.rect(m - J, u - J, r - m + 2 * J, w - u + 2 * J),
        k.stroke());
      k.restore();
      !0 === N &&
        (k.save(),
  ...
  V.prototype.setOptions = function (k, m) {
    if (qa[this._defaultsKey]) {
      ...
      for (w in r)
        "publicProperties" !== w &&
          r.hasOwnProperty(w) &&
          (this[w] = k && w in k ? k[w] : m && w in m ? m[w] : r[w]);
      ...
      : this.parent &&
        ...
        (null === H
          ...
          : 0 < this.parent.themeOptions[F].length &&
            ((w = Math.min(this.parent.themeOptions[F].length - 1, H)),
            (w = this.parent.themeOptions[F][w])));
    this.themeOptions = w;
    k in m &&
      (y = k in this.options ? this.options[k] : w && k in w ? w[k] : m[k]);
  ...
  V.prototype.dispatchEvent = function (k, m, r) {
    if (k && this._eventListeners[k]) {
      m = m || {};
      for (var w = this._eventListeners[k], y = 0; y < w.length; y++)
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
          ...
          "left" === this.horizontalAlign
            ...
            : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - D),
  ...
  y = Qa.Chart = (function () {
    ...
    function u(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[t].x > a[f].x && 0 < A) || (a[t].x < a[f].x && 0 > A)
              ? { x: a[t].x + A / 3, y: a[t].y + b / 3 }
              : { x: a[t].x, y: a[t].y + b / 9 };
          t = e;
          f = 0 === t ? 0 : t - 1;
          l = t === a.length - 1 ? t : t + 1;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          for (var h = 0; h < t.dataSeriesIndexes.length; h++)
            this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[h]]);
          this.animatedRender &&
            ((t.targetCanvasCtx.miterLimit = e), A && c.push(A));
        }
          ...
          p._animator.animate(
            ...
            function (a) {
              ...
              p.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(p.width * ga),
                Math.floor(p.height * ga),
                0,
                0,
                p.width,
                p.height
          ...
          if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (t.dataPoints[A].x && t.dataPoints[A].x.getTime) ||
            "dateTime" === t.xValueType
          )
            f = !0;
          for (A = 0; A < t.dataPoints.length; A++) {
            "undefined" === typeof t.dataPoints[A].x &&
              (t.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
            t.dataPoints[A].x.getTime
              ? ((f = !0), (b = t.dataPoints[A].x.getTime()))
              : (b = t.dataPoints[A].x);
            e = t.dataPoints[A].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (b < q && !h) null !== e && (n = b);
              ...
              t.dataPoints[A].label &&
                (a.axisX.labels[b] = t.dataPoints[A].label);
        ...
        for (
          ...
          for (p = 0; p < h.dataPoints.length; p++) {
            ...
            h.dataPoints[p].x.getTime
              ? ((t = !0), (b = h.dataPoints[p].x.getTime()))
              : (b = h.dataPoints[p].x);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (A = 0; A < t.dataPoints.length; A++)
            "undefined" !== typeof t.dataPoints[A].isCumulativeSum &&
            !0 === t.dataPoints[A].isCumulativeSum
              ? ((t.dataPointEOs[A].cumulativeSumYStartValue = 0),
                (t.dataPointEOs[A].cumulativeSum =
                  0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum),
                (t.dataPoints[A].y =
                  0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum))
              : "undefined" !== typeof t.dataPoints[A].isIntermediateSum &&
              ...
              ? ((t.dataPointEOs[A].cumulativeSumYStartValue = n),
                ...
                (b = 0))
              : ((e =
                  "number" !== typeof t.dataPoints[A].y
                    ? 0
                    : t.dataPoints[A].y),
                (t.dataPointEOs[A].cumulativeSumYStartValue =
                  0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum),
                (t.dataPointEOs[A].cumulativeSum =
                  0 === A ? e : t.dataPointEOs[A - 1].cumulativeSum + e),
                (b += e));
          for (A = 0; A < t.dataPoints.length; A++)
            if (
              ("undefined" === typeof t.dataPoints[A].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              t.dataPointEOs[A].cumulativeSum < d.min &&
                (d.min = t.dataPointEOs[A].cumulativeSum),
              t.dataPointEOs[A].cumulativeSum > d.max &&
                (d.max = t.dataPointEOs[A].cumulativeSum),
              0 < A &&
                (a.axisX.logarithmic
                  ? ((n = b / t.dataPoints[A - 1].x),
                    1 > n && (n = 1 / n),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        t.dataPointEOs[A].cumulativeSum /
                        t.dataPointEOs[A - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < A &&
                (t.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = t.dataPointEOs[A - 1].cumulativeSum),
                t.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = t.dataPointEOs[A - 1].cumulativeSum));
              t.dataPointEOs[A].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = t.dataPointEOs[A].cumulativeSum);
              t.dataPointEOs[A].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = t.dataPointEOs[A].cumulativeSum);
            }
          t.axisX.valueType = t.xValueType = f ? "dateTime" : "number";
        }
    };
                  ...
                  if (
                    ...
                    if (
                      ...
                      for (var w = 0; w < g.length; w++)
                        (n = Math.floor((g[w] - p) / m)),
                          g[w] < d[n].min && (d[n].min = g[w]),
                          g[w] > d[n].max && (d[n].max = g[w]);
                    else
                      r(g) ||
                        ((n = Math.floor((g - p) / m)),
                        g < d[n].min && (d[n].min = g),
      ...
      for (l = 0; l < h.length; l++) {
        ...
        if (q > g)
          var v = g,
            ...
            q = v;
        if (n.scaleBreaks)
          for (v = 0; !f && v < n.scaleBreaks._appliedBreaks.length; v++)
            f =
              n.scaleBreaks._appliedBreaks[v].startValue <= q &&
              n.scaleBreaks._appliedBreaks[v].endValue >= g;
          ...
          if (
            ...
            !(
              ...
              (!(
                ...
                ((n.logarithmic && v < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && v < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              g > n.maximum
            ))
          )
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (
          ...
          s = this.getPercentAndTotal(h.dataSeries, h.dataPoint);
        ...
        if (null !== E && "" !== E) {
          ...
          if ("stackedarea100" === p) {
            ...
            if (
              h.dataPoint.x < z.viewportMinimum ||
              h.dataPoint.x > z.viewportMaximum ||
          ...
          e = l = 2;
          "horizontal" === x
            ? ((t = g.width), (A = g.height))
            : ((A = g.width), (t = g.height));
              ...
              : ((e = Math.max(h.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < C
                      ? Math.max(h.bounds.y1, c.y1) + A / 2 + l
                      : Math.min(h.bounds.y2, c.y2) - A / 2 - l
                ...
                0 < C
                  ? ((q = Math.max(h.point.y, b)),
                    q < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.max(h.point.y - A - l, c.y1 + l)))
                  : ((q = Math.min(h.point.y, b)),
                    q > f - A - l &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.min(h.point.y + l, c.y2 - A - l))),
                (q = Math.min(q, f)));
          } else
            0 <= p.indexOf("line") ||
            0 <= p.indexOf("area") ||
            0 <= p.indexOf("scatter")
              ...
              "inside" !== s
                ? ((l = c.x1),
                  ...
                  0 > C
                    ? ((n =
                        h.point.x - ("horizontal" === x ? t : t / 2) - e - b),
                      n < l &&
                        ((n =
                          "auto" === s
                        ...
                        (u = n + t > h.point.x)))
                    : ((n =
                        h.point.x + ("horizontal" === x ? 0 : t / 2) + e + b),
                      n > f - t - e - b &&
                        ((n =
                          "auto" === s
                ...
                : ((l = Math.max(h.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > C
                        ? Math.max(h.bounds.x1, c.x1) + t / 2 + e
                        : Math.min(h.bounds.x2, c.x2) - t / 2 - e
          ...
          m &&
            ...
            0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
              ...
              ? d.lineTo(
                  n + ("horizontal" === x ? t / 2 : 0),
                  q +
                    ((0 < h.direction ? A : -A) + ("vertical" === x ? -A : 0)) /
                      2
                )
              : d.lineTo(
                  n + ("horizontal" === x ? t / 2 : 0),
                  q +
                    ((q < h.point.y ? A : -A) + ("vertical" === x ? -A : 0)) / 2
                ),
            d.stroke());
        }
      }
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < p.length) {
            for (var C = !1, s = 0; s < p.length; s++)
              if (
                ((x = p[s].x.getTime ? p[s].x.getTime() : p[s].x),
                !(
                  ...
                  m || C
                    ...
                    : (c.lineTo(x, r),
                      ...
                      0 == s % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(x, r),
                        w && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                  l = { x: x, y: r };
                  s < p.length - 1 &&
                    (k !== (p[s].lineColor || v) ||
                      n !== (p[s].lineDashType || h.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, r),
                    (k = p[s].lineColor || v),
                    ...
                    c.setLineDash &&
                      (p[s].lineDashType
                        ? ((n = p[s].lineDashType),
                          c.setLineDash(N(n, h.lineThickness)))
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < p.length) {
            for (var C = !1, s = 0; s < p.length; s++)
              if (
                ((x = p[s].getTime ? p[s].x.getTime() : p[s].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !C))
                  ...
                  s < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[s].lineDashType
                        ...
                        : ((n = h.lineDashType), c.setLineDash(g))));
                  if (0 < p[s].markerSize || 0 < h.markerSize)
                    (z = h.getMarkerProperties(s, x, r, c)),
                      f.push(z),
                      (B = Q(B)),
                      w &&
                        f.push({
        ...
        for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < p.length)
            for (x = !1, m = 0; m < p.length; m++)
              if (
                ((s = p[m].getTime ? p[m].x.getTime() : p[m].x),
                !(
                ...
                if ("number" !== typeof p[m].y)
                  ...
                  m < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[m].lineDashType
                        ? ((n = p[m].lineDashType),
                          (r[r.length - 1].newLineDashArray = N(
                            n,
                            h.lineThickness
                          )))
                        : ((n = h.lineDashType),
        ...
        for (p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[f].getTime ? (A = v[f].x.getTime()) : (A = v[f].x),
                !(
        ...
        for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < s.length) {
            ...
            for (h = 0; h < s.length; h++)
              if (
                ((b = s[h].x.getTime ? s[h].x.getTime() : s[h].x),
                !(
                ...
                if (
                  ...
                  (A[b] = s[h].y + (A[b] ? A[b] : 0)),
                    (z = a.axisY.convertValueToPixel(A[b])),
                    (n = "undefined" !== typeof l[b] ? l[b] : q),
                    (l[b] = z);
                else if (
                  ((n = a.axisY.convertValueToPixel(s[h].y)), 0 <= s[h].y)
                ) {
            ...
            for (
              ...
              if (
                ...
                if (
                  ...
                  (A[b] = n + ("undefined" !== typeof A[b] ? A[b] : 0)),
                    (z = a.axisY.convertValueToPixel(A[b])),
                    (n = l[b] ? l[b] : q),
                    (l[b] = z);
            ...
            for (h = 0; h < s.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = s[h].y + (A[b] ? A[b] : 0)),
                    (p = l[b] ? l[b] : q),
                    (l[b] = z = a.axisY.convertValueToPixel(A[b]));
                else if (
                  ((p = a.axisY.convertValueToPixel(s[h].y)), 0 <= s[h].y)
                ) {
                  var B = f[b] ? f[b] : 0;
                  z = q + B;
                  p += B;
            ...
            for (h = 0; h < s.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = r + (A[b] ? A[b] : 0)),
                    (p = l[b] ? l[b] : q),
                    (l[b] = r = a.axisY.convertValueToPixel(A[b]));
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < v.length) {
            ...
            for (var ja = !0; k < v.length; k++)
              if (
                ((r = v[k].x.getTime ? v[k].x.getTime() : v[k].x),
                !(
                ...
                if ("number" !== typeof v[k].y)
                  ...
                  0 !== v[k].markerSize &&
                    ...
                    ((r = g.getMarkerProperties(k, m, s, f)),
                    A.push(r),
                    (aa = Q(aa)),
                    w &&
                      A.push({
            ...
            for (v = !1; q < n.length; q++)
              if (
                ...
                if ("number" !== typeof n[q].y)
                  ...
                  q < n.length - 1 &&
                    (z !== (n[q].lineColor || C) ||
                      B !== (n[q].lineDashType || p.lineDashType)) &&
                    ((z = n[q].lineColor || C),
              ...
              if (
                ...
                "number" !== typeof v[k].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    0 !== v[k].markerSize &&
                      (0 < v[k].markerSize || 0 < g.markerSize) &&
                      ((aa = g.getMarkerProperties(k, m, s, f)),
                      A.push(aa),
                      (r = Q(r)),
                      w &&
                        A.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          for (q = 0; q < u.length; q++)
            (z = u[q].x.getTime ? u[q].x.getTime() : u[q].x),
              (B.dataPointIndexes[z] = q),
              e[z] || (p.push(z), (e[z] = !0));
          p.sort(Ra);
        }
            ...
            for (var aa = !0, q = 0; q < p.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  x || aa
                    ? (!x && B.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(E),
                            h.push(x),
                            (E = B.nullDataLineDashType),
                            b.setLineDash(P)),
                          b.lineTo(g, k),
                          w && r.lineTo(g, k))
                        : (b.beginPath(),
                          b.moveTo(g, k),
                          w && (r.beginPath(), r.moveTo(g, k))),
                      (aa = x = !1))
                    : (b.lineTo(g, k),
                      w && r.lineTo(g, k),
                      0 == q % 250 &&
                  ...
                  q < u.length - 1 &&
                    (S !== (u[q].lineColor || y) ||
                      E !== (u[q].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: m - ma }),
                    ...
                    b.setLineDash &&
                      (u[q].lineDashType
                        ? ((E = u[q].lineDashType),
                          b.setLineDash(N(E, B.lineThickness)))
                        : ((E = B.lineDashType), b.setLineDash(D))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          for (q = 0; q < y.length; q++)
            (z = y[q].x.getTime ? y[q].x.getTime() : y[q].x),
              (B.dataPointIndexes[z] = q),
              e[z] || (p.push(z), (e[z] = !0));
          p.sort(Ra);
        }
            ...
            for (var aa = !0, q = 0; q < p.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < y.length - 1 &&
                    (S !== (y[q].lineColor || D) ||
                      s !== (y[q].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, v),
                    h.push({ x: g, y: x - ba }),
                    ...
                    b.setLineDash &&
                      (y[q].lineDashType
                        ? ((s = y[q].lineDashType),
                          b.setLineDash(N(s, B.lineThickness)))
                        : ((s = B.lineDashType), b.setLineDash(F))));
                  if (0 <= B.dataPointIndexes[f]) {
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < B.markerSize) &&
                    ((ba = B.getMarkerProperties(q, g, v, b)),
                    t.push(ba),
                    (f = Q(G)),
                    w &&
                      t.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < x.length)
            for (
              var E = 5 < v && s.bevelEnabled ? !0 : !1, t = 0;
              t < x.length;
              t++
            )
              if (
                ...
                "candlestick" === s.type
                  ? (c.moveTo(k - y, p),
                    ...
                    ca(
                      ...
                      z,
                      Math.max(h, q),
                      x[t].y[0] <= x[t].y[3] ? s.risingColor : f,
                      B,
                      e,
                      E,
                      E,
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var m = !1, m = !!a.axisY.reversed, u = 0;
          ...
          if (0 < E.length)
            for (
              var C = 5 < v && x.bevelEnabled ? !0 : !1, l = 0;
              l < E.length;
              l++
            )
              if (
                ...
                var z = (t - v / 2) << 0,
                  ...
                  S = E[l].whiskerColor
                    ...
                    : e,
                  P =
                    "number" === typeof E[l].whiskerThickness
                      ? E[l].whiskerThickness
                  ...
                  ma = E[l].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof E[l].stemThickness
                      ? E[l].stemThickness
                  ...
                  J = E[l].lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof E[l].lineThickness
                      ? E[l].lineThickness
                ...
                w &&
                  ...
                  0 < ba &&
                    (b.moveTo(t - D - G, h),
                    b.lineTo(t - D - G, Math.max(k, n)),
                    b.stroke(),
                    b.moveTo(t - D - G, Math.min(k, n)),
                    b.lineTo(t - D - G, p),
                    b.stroke()),
                  ca(
                    b,
                  ...
                  0 < P &&
                    (b.beginPath(),
                    (b.lineWidth = P),
                    b.moveTo(t + aa / 2, n - fa),
                    b.lineTo(t - aa / 2, n - fa),
                    b.stroke(),
                    b.moveTo(t + aa / 2, k + fa),
                    b.lineTo(t - aa / 2, k + fa),
                    b.stroke()));
                (E[l].indexLabel ||
                  x.indexLabel ||
                  E[l].indexLabelFormatter ||
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w &&
          ...
          this._eventManager.ghostCtx.clip());
        for (var u = 0, s = 0; s < this.data.length; s++)
          !this.data[s].type.match(/(bar|column)/gi) ||
            !this.data[s].visible ||
            (this.data[s].type.match(/(stacked)/gi) && u) ||
            u++;
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          if (B)
            for (e = C._linkedSeries.id, s = 0; s < e; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                ...
                (this.data[s].type.match(/(range)/gi) && (f = !0), D++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (B ? u : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (t = this.options.dataPointMaxWidth
            ...
            for (var F = C._colorSet, t = 0; t < z.length; t++) {
              var e = (C.lineColor = C.options.color ? C.options.color : F[0]),
                S = {
                  color: z[t].whiskerColor
                    ...
                    ? C.whiskerColor
                    : e,
                  thickness: r(z[t].whiskerThickness)
                    ? C.whiskerThickness
                    : z[t].whiskerThickness,
                  dashType: z[t].whiskerDashType
                    ? z[t].whiskerDashType
                    : C.whiskerDashType,
                  length: r(z[t].whiskerLength)
                    ? r(C.options.whiskerLength)
                      ? s
                      : C.options.whiskerLength
                    : z[t].whiskerLength,
                  trimLength: r(z[t].whiskerLength)
                    ? r(C.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var P = {
                color: z[t].stemColor
                  ...
                  ? C.stemColor
                  : e,
                thickness: z[t].stemThickness
                  ? z[t].stemThickness
                  : C.stemThickness,
                dashType: z[t].stemDashType
                  ? z[t].stemDashType
                  : C.stemDashType,
              };
              P.thickness =
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (h + ((B ? u : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (h - ((B ? u : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                    (g = a.axisX.reversed ? (q - s) << 0 : (q + s) << 0))
                  : ((p = a.axisX.reversed
                      ? (k + ((B ? u : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (k - ((B ? u : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                    (n = a.axisX.reversed ? (p - s) << 0 : (p + s) << 0));
                !b && q > g && ((ja = q), (q = g), (g = ja));
                b && p > n && ((ja = p), (p = n), (n = ja));
                ja = C.dataPointIds[t];
            ...
            for (var S = !0; g < n.length; g++)
              if (
                ...
                if (
                  ...
                  g < n.length - 1 &&
                    (z !== (n[g].lineColor || C) ||
                      B !== (n[g].lineDashType || p.lineDashType)) &&
                    (d(),
                    (z = n[g].lineColor || C),
            ...
            for (g = !1; n < p.length; n++)
              if (
                ...
                if (
                  ...
                  n < p.length - 1 &&
                    (E !== (p[n].lineColor || x) ||
                      C !== (p[n].lineDashType || h.lineDashType)) &&
                    ((E = p[n].lineColor || x),
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              ...
              if (
                (u[l].getTime ? (p = u[l].x.getTime()) : (p = u[l].x),
                "number" !== typeof u[l].y)
              ) {
                if (0 < l && !C && r.connectNullData)
                  var y =
                    r.options.nullDataLineDashType || !u[l - 1].lineDashType
                ...
                var P,
                  S = k;
                P =
                  ("undefined" !== typeof u[l].isIntermediateSum &&
                    !0 === u[l].isIntermediateSum) ||
                  ("undefined" !== typeof u[l].isCumulativeSum &&
                    !0 === u[l].isCumulativeSum)
                    ? 0 < u[l].y
                      ? m
                      : h
                    : 0 < u[l].y
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (h && p) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
            ...
            k.indexLabelLineColor = f.indexLabelLineColor
            ...
            k.indexLabelLineThickness = r(f.indexLabelLineThickness)
              ? h.indexLabelLineThickness
              : f.indexLabelLineThickness;
            k.indexLabelLineDashType = f.indexLabelLineDashType
              ? f.indexLabelLineDashType
              : h.indexLabelLineDashType;
            k.indexLabelFontColor = f.indexLabelFontColor
              ? f.indexLabelFontColor
              : h.indexLabelFontColor;
            k.indexLabelFontStyle = f.indexLabelFontStyle
              ? f.indexLabelFontStyle
              : h.indexLabelFontStyle;
            k.indexLabelFontWeight = f.indexLabelFontWeight
              ? f.indexLabelFontWeight
              : h.indexLabelFontWeight;
            k.indexLabelFontSize = r(f.indexLabelFontSize)
              ? h.indexLabelFontSize
              : f.indexLabelFontSize;
            k.indexLabelFontFamily = f.indexLabelFontFamily
              ? f.indexLabelFontFamily
              : h.indexLabelFontFamily;
            k.indexLabelBackgroundColor = f.indexLabelBackgroundColor
          ...
          for (e = 0; e < p.length; e++)
            (k = g[(c + e) % p.length]),
              1 < a &&
                k.midAngle > Math.PI / 2 - s &&
                k.midAngle < Math.PI / 2 + s &&
                (f <= a / 2 && !n
                  ? ((k.hemisphere = "right"), f++)
                  : ((k.hemisphere = "left"), (n = !0)));
          n = !1;
          for (e = 0; e < p.length; e++)
            (k = g[(d + e) % p.length]),
              1 < b &&
      ...
      function c(a) {
        ...
        for (b = 0; b < p.length; b++) {
          ...
          if (d > c) {
            ...
            if (p[b].exploded) {
              if (
                1e-9 < Math.abs(g[b].center.x - (E.x + e)) ||
                1e-9 < Math.abs(g[b].center.y - (E.y + f))
              )
                (g[b].center.x = E.x + e * a),
                  (g[b].center.y = E.y + f * a),
                  (l = !0);
            } else if (
              0 < Math.abs(g[b].center.x - E.x) ||
              0 < Math.abs(g[b].center.y - E.y)
            )
              (g[b].center.x = E.x + e * (1 - a)),
                (g[b].center.y = E.y + f * (1 - a)),
                (l = !0);
            l &&
              ((e = {}),
              (e.dataSeries = h),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < p.length) {
          ...
          l =
            "right" === n.hemisphere
              ? E.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - E.y, 2))
              : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - E.y, 2));
          ...
          h &&
            ...
            (c =
              "right" === n.hemisphere
                ? E.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2))
                : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2))),
            ...
            (n.indexLabelAngle = Math.atan2(
              n.indexLabelTextBlock.y - E.y,
              n.indexLabelTextBlock.x - E.x
            )));
        }
        return h;
      }
      function l() {
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (var t, r, a = 0; a < p.length; a++) {
              ...
              if (null !== s) {
                ...
                var z = 0,
                  z = b(t, r) - v;
                if (0 > z) {
                  for (var y = (r = 0), C = 0; C < p.length; C++)
                    C !== a &&
                      g[C].hemisphere === k.hemisphere &&
                      (g[C].indexLabelTextBlock.y < k.indexLabelTextBlock.y
                        ? r++
                        : y++);
                  r = (z / (r + y || 1)) * y;
                  var y = -1 * (z - r),
            ...
            for (a = 0; a < p.length; a++)
              (k = g[a]),
                (w = "pie" === h.type ? 0.7 * B : 0.8 * B),
                (s = E.x + w * Math.cos(k.midAngle)),
                (r = E.y + w * Math.sin(k.midAngle)),
                (k.indexLabelTextBlock.x = s),
                (k.indexLabelTextBlock.y = r);
          for (a = 0; a < p.length; a++)
            if (
              ((k = g[a]),
              (s = k.indexLabelTextBlock.measureText()),
              ...
              (s = s = 0),
                ...
                0 < s &&
                  (!l &&
                    ...
                    0.3 * k.indexLabelTextBlock.maxWidth > r
                      ? (k.indexLabelText = "")
                      : (k.indexLabelTextBlock.maxWidth = 0.85 * r),
                    0.3 * k.indexLabelTextBlock.maxWidth < r &&
                      (k.indexLabelTextBlock.x -=
                  ...
                  ((s /= Math.abs(Math.cos(k.indexLabelAngle))),
                  9 < s && (s *= 0.3),
                  s > d && (d = s)),
                (s = s = 0),
                  ...
                  (!l &&
                    ...
                    ((r =
                      0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, s * r) && f(a, 2 * r)),
                  Math.abs(k.indexLabelTextBlock.x - E.x) < B &&
                    ((s /= Math.abs(Math.sin(k.indexLabelAngle))),
                    9 < s && (s *= 0.3),
                    s > d && (d = s)));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < p.length; z++)
          (y += Math.abs(p[z].y)),
            !a &&
              "undefined" !== typeof p[z].indexLabel &&
              null !== p[z].indexLabel &&
              0 < p[z].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof p[z].label &&
              null !== p[z].label &&
              0 < p[z].label.toString().length &&
              (a = !0);
        if (0 !== y) {
          a =
            a ||
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (
                ...
                var l = p[c].color
                  ? p[c].color
                  : h._colorSet[c % h._colorSet.length];
                e > d &&
                  Y(
                    m.plotArea.ctx,
                    g[c].center,
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var l = (d[0] = 0), k = 0, n, p, b = b - a, l = !1, h = 0;
          h < x.length;
          h++
        )
        ...
        if (s && x) {
          ...
          for (var z = 0, E = x.length - 1; z < x.length || 0 <= E; z++, E--) {
            ...
            a = b.color
              ? b.color
              : s.reversed
              ? s._colorSet[(x.length - 1 - z) % s._colorSet.length]
              : s._colorSet[z % s._colorSet.length];
      ...
      function e() {
        ...
        for (
          var g,
            h = J - Z - V / 2,
            h = s.options.indexLabelMaxWidth
              ? s.indexLabelMaxWidth > h
                ? h
                : s.indexLabelMaxWidth
              : h,
            l = I.length - 1;
          ...
          for (var l, k = 1; k < h; k++) {
            ...
            for (var m = I.length - 1; 0 <= m; m--)
              !I[m].isDirty &&
                ...
                ((l = q(m)),
                !(l >= I.length - 1) &&
                  I[m].textBlock.y + I[m].height + da > I[l].textBlock.y &&
                  (I[m].textBlock.y =
                    I[m].textBlock.y + I[m].height - e > e - I[m].textBlock.y
                      ? e + 1
                      : e - I[m].height - 1));
          }
      ...
      function k(a, b) {
        return (
          (b < O.length ? I[b].textBlock.y : s.reversed ? na + C : sa + C) -
          (0 > a
            ? s.reversed
              ? sa - C
              : na - C
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var s = this.data[a.dataSeriesIndexes[0]],
            ...
            B = 0,
            D = E.height - 2 * C,
            F = Math.min(E.width - 2 * z, 2.8 * E.height),
            H = !1,
            P = 0;
          P < x.length;
          P++
          ...
          if (
            ...
            !H &&
              ...
              (H = !0),
            (!H && "function" === typeof s.indexLabelFormatter) ||
        ...
        ("inside" !== s.indexLabelPlacement && H) ||
          (z = (E.width - 0.75 * F) / 2);
        var P = E.x1 + z,
          J = E.x2 - z,
          M = E.y1 + C,
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== x.length) {
          ...
          "funnel" === s.type
            ? ((ba = r(s.options.neckHeight) ? 0.35 * D : s.neckHeight),
              ...
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === s.type &&
              ((G = ba = 0), (s.reversed = s.reversed ? !1 : !0));
          var z = P + a / 2,
            X = P,
            Z = P + a,
            na = s.reversed ? Q : M,
          ...
          if (-1 !== P) {
            ...
            if (s.reversed)
              for (G = 0; G < P.length; G++)
                F[G] < xa
                  ? (a.push(K), z.push(W), (ca = G))
                  : (a.push((F[G] - na + $ * X) / $),
                    z.push((F[G] - na + ea * Z) / ea));
            else
              for (G = 0; G < P.length; G++)
                F[G] < xa
                  ? (a.push((F[G] - na + $ * X) / $),
            ...
            for (G = 0; G < P.length - 1; G++)
              (U = s.reversed
                ? x[x.length - 1 - G].color
                  ? x[x.length - 1 - G].color
                  : s._colorSet[(x.length - 1 - G) % s._colorSet.length]
                : x[G].color
                ? x[G].color
            ...
            for (G = 0; G < x.length; G++)
              x[G].exploded &&
                ((P = !0), s.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            ...
            if (
              H &&
              s.visible &&
              (b(), f(), e(), "inside" !== s.indexLabelPlacement)
            ) {
              l();
              for (G = 0; G < x.length; G++)
                I[G].isDirty ||
            ...
            for (G = 0; G < O.length; G++)
              (B = O[G]), qa(R, B, s.fillOpacity), ga.push(B.y1);
            u(R);
            H &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || p(R),
              y.animationEnabled || v());
            if (!H)
              for (G = 0; G < x.length; G++)
                (B = s.dataPointIds[G]),
                  (a = {
        ...
        if (n.dataPoints && n.dataPoints.length)
          if (
            ...
            for (var x = 0; x < n.dataPoints.length; x++) {
              ...
              (y.showInLegend || (n.showInLegend && !1 !== y.showInLegend)) &&
                m.push(q);
            }
      }
                    ...
                    if (r(this.options.labelWrap))
                      if (!r(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          ((0 === u &&
                            q +
                              this._labels[u + 1].textBlock.measureText()
                                .width -
                              2 * f >
                              n) ||
                            (u === this._labels.length - 1 &&
                              q +
                                this._labels[u - 1].textBlock.measureText()
                                  .width -
                                2 * f >
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      if ("normal" === e) {
        for (
          ...
          m = Math.round(
            f.x2 - $ - Z > p.width - n ? p.width - n : f.x2 - $ - Z
          );
          if (a && 0 < a.length)
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? D + s > m &&
                      (k += 0 < a[g].labelAngle ? D + s - m - $ : 0)
                    : 0 > a[g].labelAngle
                    ? B - u < l &&
                      B - u < a[g].viewportMinimum &&
                      (F =
                        l -
                        (K +
                          a[g].tickLength +
                  ...
                  0 < k
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < F && (l += F), 0 < k && (m -= k))),
                p.panEnabled
                  ? (U = r(p.sessionVariables.axisX.height)
                      ? (p.sessionVariables.axisX.height = U)
                ...
                d[g]._labels &&
                  ...
                  (s =
                    ...
                    (k.textBlock.height - k.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                p.panEnabled
                  ? (W = r(p.sessionVariables.axisX2.height)
                      ? (p.sessionVariables.axisX2.height = W)
              ...
              b[g] &&
                ...
                (K =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (k = Math.round(
                  f.y1 + W + X < Math.max(K, n) ? Math.max(K, n) : f.y1 + W + X
                )),
                (K =
                  0 < a.length
                    ? 0
        ...
        for (N = []; 4 > w; ) {
          ...
          if (d && 0 < d.length)
            ...
            u.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
          N.push(u);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - U - X > p.width - 10 ? p.width - 10 : f.x2 - U - X
                )),
                c[g].labelAutoFit &&
                  !r(x) &&
                  (0 < !a.length &&
    ...
    $.prototype.render = function (a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var y = 0; y < this.parent.dataSeries.length; y++)
            (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) &&
              0 <= u.index &&
              ((u.dataSeries = this.parent.dataSeries[y]),
              null !== u.dataPoint.y && u.dataSeries.visible && p.push(u));
          u = null;
          ...
          if (
            ...
            for (
              var u = Math.abs(
                  a - this.parent.convertValueToPixel(p[y].dataPoint.y[0])
                ),
                s = 0,
                v = 0;
              v < p.length;
              ...
              if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                for (var x = 0; x < p[v].dataPoint.y.length; x++)
                  (s = Math.abs(
                    a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])
                  )),
                    s < u && ((u = s), (y = v));
              else
                (s = Math.abs(
                  a - this.parent.convertValueToPixel(p[v].dataPoint.y)
                )),
                  s < u && ((u = s), (y = v));
            ...
            for (
              ...
              if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                for (x = 0; x < p[v].dataPoint.y.length; x++)
                  (s = Math.abs(
                    a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])
                  )),
                    s < u && ((u = s), (y = v));
                ...
                (E += p[v].dataPoint.y),
                  (s = Math.abs(a - this.parent.convertValueToPixel(E))),
                  s < u && ((u = s), (y = v));
            ...
            for (
              ...
              if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                ...
                (E += p[v].dataPoint.y),
                  (C = p[v].dataPoint.x.getTime
                    ? p[v].dataPoint.x.getTime()
                    : p[v].dataPoint.x),
          ...
          if (
            ...
            if (
              ...
              for (v = s = 0; v < x.dataPoint.y.length; v++)
                (s = Math.abs(
            ...
            if (this.parent.labels)
              for (
                p = Math.ceil(this.parent.interval), v = 0;
          ...
          if (C) {
            if ("axisX" === this.parent.type)
              for (
                v = this.parent.convertPixelToValue({ x: a }), u = null, y = 0;
                y < this.parent.dataSeries.length;
                y++
              )
                (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                for (x = 0; x < p[v].dataPoint.y.length; x++)
                  (s = Math.abs(
                    d - this.parent.convertValueToPixel(p[v].dataPoint.y[x])
                  )),
                    s < u && ((u = s), (y = v));
              else
                (s = Math.abs(
                  d - this.parent.convertValueToPixel(p[v].dataPoint.y)
                )),
                  s < u && ((u = s), (y = v));
          else if (
            ...
            for (
              ...
              if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                ...
                (E += p[v].dataPoint.y),
                  (s = Math.abs(d - this.parent.convertValueToPixel(E))),
                  s < u && ((u = s), (y = v));
          else if (
        ...
        if (
          ...
          (f = k = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: k + n / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var u = 0; u < this.chart.axisX.length; u++) {
                for (
                  var k = this.chart.axisX[u].convertPixelToValue({ y: d }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[u].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[u].dataSeries[b]),
            ...
            if (this.chart.axisX2)
              for (u = 0; u < this.chart.axisX2.length; u++) {
                ...
                for (b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)
                  (h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[u].dataSeries[b]),
                    null !== h.dataPoint.y && m.push(h));
                h = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (u = 0; u < this.chart.axisX.length; u++)
                for (
                  k = this.chart.axisX[u].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[u].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (u = 0; u < this.chart.axisX2.length; u++)
                for (
                  k = this.chart.axisX2[u].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX2[u].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(
                    k,
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((h = $a(a, d, this.chart._eventManager.ghostCtx)),
              0 < h &&
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", k = !0, m = 0;
        m < a.length;
        m++
      )
